...
if __name__ == "__main__":
    input_filename = '../ProcessingSteps/step1_results.json'  # Update this with the path to your input file
    output_filename = '../ProcessingSteps/step2_results.json'  # Desired path for the output file
